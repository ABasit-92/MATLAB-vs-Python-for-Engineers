...
% COMPUTATIONAL ENGINE OF THE CODE.
...
colormap(flipud(gray(256))); brighten(-0.8); 
cmap=colormap;

% plotting the image/figure

im=image([mu_edges(1) mu_edges(end)], [x_edges(1) x_edges(end)], x_histogram);
set(gca,'YDir','normal');
xlabel('$\mu$','Interpreter','latex','FontSize',14);
ylabel('$x\;\;$','Interpreter','latex','FontSize',14);
title('Logistic Map Bifurcation Diagram in MATLAB','Interpreter','latex','FontSize',16)